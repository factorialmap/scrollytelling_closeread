...
Vamos explorar os resultados apresentados na análise fatorial exploratória. @cr-case1_fa_res


::: {#cr-case1_fa_res .scale-to-fill}
```{r cr-case1_fa_res, warning=FALSE, message=FALSE, echo=TRUE}

# mostrando os resultados da analise fatorial exploratória
efa_result
