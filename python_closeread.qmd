...
Now, how to explain this chart?


PCE is personal consumption expenditure. [@cr-kpi]{zoom-to="12"}

pop is population of United States. [@cr-kpi]{pan-to ="-55%, 50%" scale-by ="2"} 

psvert is saving rates in pencentage. [@cr-kpi]{pan-to = "25%, -50%" scale-by = "1.5"}

unemploy is unemployment rate. [@cr-kpi]{pan-to = "-76%, -50%" scale-by = "2"}
